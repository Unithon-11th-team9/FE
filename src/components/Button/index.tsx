...
const buttonStyles = {
	button1: " rounded-button text-white bg-point text-mainText p-button hover:bg-point/70",
	button2: "rounded-button text-white bg-point text-mainText p-button hover:bg-point/70",
	button2_off: "rounded-button text-white/50 bg-back03 text-mainText p-button hover:bg-back03/70",
	button3: "rounded-button text-point bg-white text-mainText p-button hover:bg-back03",
