...
const textStyles = {
	title_01: "text-white font-['PyeongChangPeace-Bold'] text-4xl",
	title_02: "text-white font-['PyeongChangPeace-Bold'] text-4xl",
	...
	sub_text_01: "text-white text-xs leading-subText01",
	sub_text_02: "text-white text-xs leading-subText02",
	sub_text_03: "text-white text-xs leading-subText03 font-[SBAggroL]",
};
